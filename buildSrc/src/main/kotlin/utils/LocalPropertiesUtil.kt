...
fun getLocalProperty(propertyName: String, project: Project): String =
    getLocalPropertyOrNull(propertyName, project) ?: throw NoSuchFieldException("Not defined property: $propertyName")

fun getLocalPropertyOrNull(propertyName: String, project: Project): String? {
